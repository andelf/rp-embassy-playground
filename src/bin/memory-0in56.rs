...
use memory_lcd_spi::displays::LS006B7DH01;
...
async fn main(_spawner: Spawner) {
    ...
    let mut display: MemoryLCD<LS006B7DH01, _, _> = MemoryLCD::new(spi, cs);
    ...
    let cube_size = 23.0;
    let screen_offset_x = 64.0 / 2.0;
    let screen_offset_y = 64.0 / 2.0;
